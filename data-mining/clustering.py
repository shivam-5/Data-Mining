...
for i in range(0, whole_cust.columns.size):
    for ii in range(i + 1, whole_cust.columns.size):
        # Plot all figured together.
        # Used for showing while execution. Use individual plots for saving to local system
        plt.subplot(5, 3, pltIdx)
        
        # Use this for individual plotting (for saving plots to add to the report)
        # plt.subplot(1, 1, 1)
        ...
        # Code for saving individual plots. Used only for report
        # filename = whole_cust.columns[i] + "-" + whole_cust.columns[ii] + ".jpg"
        # plt.savefig("./plots/" + filename)

# Comment this out if need to save individual plot to local system.
# This will show only last plot in that case
plt.show()


# ----------------------------------------------------------------------------------------------------------- #
# Q3 This constitutes Question 3 of Clustering
# ----------------------------------------------------------------------------------------------------------- #
